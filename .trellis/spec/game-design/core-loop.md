...
Flow:
1. AI generates the exam question (same as other levels)
2. Player submits their answer (fixed choice or free-text)
3. **3 AI rival candidates** also submit answers (generated by AI based on era/difficulty)
4. The **Emperor Judge** (highest-tier LM) ranks all 4 answers
5. Ranking determines title: 状元 (1st), 榜眼 (2nd), 探花 (3rd), 进士 (4th)
...
- **Failure**: Family line dies out (no heirs available at inheritance) or 10 generations pass without achieving 举人+
